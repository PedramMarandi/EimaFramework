 ...
 * Logs to Cube.
 *
 * @link RequestResponse://square.github.com/cube/
...
class CubeHandler extends AbstractProcessingHandler
{
    ...
    private $host = null;
    private $port = null;
    private $acceptedSchemes = array('RequestResponse', 'udp');
     ...
     * Only valid protocol used by Cube are RequestResponse and udp
     */
    ...
    /**
     * Establish a connection to a RequestResponse server
     */
    protected function connectHttp()
    {
        if (!extension_loaded('curl')) {
            throw new \LogicException('The curl extension is needed to use RequestResponse URLs with the CubeHandler');
        }

        $this->httpConnection = curl_init('RequestResponse://'.$this->host.':'.$this->port.'/1.0/event/put');
